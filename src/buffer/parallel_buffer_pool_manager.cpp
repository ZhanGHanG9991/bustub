...
ParallelBufferPoolManager::ParallelBufferPoolManager(size_t num_instances, size_t pool_size, DiskManager *disk_manager,
    ...
    : pool_size(pool_size), bpmis{num_instances} {
...
size_t ParallelBufferPoolManager::GetPoolSize() {
  ...
  return bpmis.size() * pool_size;
}

BufferPoolManager *ParallelBufferPoolManager::GetBufferPoolManager(page_id_t page_id) {
  // Get BufferPoolManager responsible for handling given page id. You can use this method in your other methods.
  return bpmis[page_id % bpmis.size()];
}
...
Page *ParallelBufferPoolManager::NewPgImp(page_id_t *page_id) {
  ...
  do {
    auto newPage = bpmis[start_index % bpmis.size()]->NewPage(page_id);
    if (newPage != nullptr) {
      last_alloc_index_ = (last_alloc_index_ + 1) % bpmis.size();
      return newPage;
    }
    start_index = (start_index + 1) % bpmis.size();
